...
export function MacbookPro({
  ...
  return (
    ...
    >
      ...
      <rect fill="#1b1e20" x="74.52" y="21.32" width="501.22" height="24" />
      {/* traffic-light dots */}
      <circle cx="91" cy="33.3" r="3.4" fill="#ff5f57" />
      <circle cx="104" cy="33.3" r="3.4" fill="#febc2e" />
      <circle cx="117" cy="33.3" r="3.4" fill="#28c840" />
      {src && (
        <g clipPath="url(#roundedCorners)">
          {/* blurred cover fills the whole screen (no empty gaps) */}
          <image
            href={src}
            x="74.52"
            y="45.32"
            ...
            filter="url(#shotBlur)"
          />
          <rect x="74.52" y="45.32" width="501.22" height="299.85" fill="#0b0e0e" opacity="0.18" />
          {/* sharp screenshot shown in full (no crop) on top */}
          <image
            href={src}
            x="74.52"
            y="45.32"
      ...
      <defs>
        <filter id="shotBlur" x="-20%" y="-20%" width="140%" height="140%">
